...
export default function Registration({ onDone, onBack }) {
  ...
  const [form, setForm] = useState({ firstName: "", lastName: "", dob: "", email: "", password: "", role: "patient", phone: "", pronouns: "", diagnoses: [], medications: "", allergies: "", notes: "", consentTreatment: false, consentData: false, consentContact: false });
